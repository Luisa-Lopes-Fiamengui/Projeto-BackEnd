...
namespace ProjetoBackend.Controllers
{
    public class FornecedoresController : Controller
    {
        ...
        public async Task<IActionResult> Search(string nome)
        {
            ...
            var fornecedors = await _context.Fornecedores.Where(c => c.Nome.Contains(nome)).ToListAsync();
            return View("Index", fornecedors.OrderBy(c => c.Nome)); // Reuse the existing Index view
        }
